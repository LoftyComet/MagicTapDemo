...
public class AcceStudy3 : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (HandJointUtils.TryGetJointPose(TrackedHandJoint.IndexTip, Handedness.Any, out IndexTipPose2))
        {
            ...
            if (Vector3.Distance(Bounds.center, IndexTipPose2.Position) <= triggerDis)
            {
                ...
                print(Bounds.center.y);
                print(Bounds.center.z);
                print(IndexTipPose2.Position.x);
                print(IndexTipPose2.Position.y);
                print(IndexTipPose2.Position.z);
                print(Vector3.Distance(Bounds.center, IndexTipPose2.Position));
                Entered = true;
                InEvent.Invoke();
                if (!Invoked)
                {
