...
namespace VRKeys {
	...
	public class Keyboard : MonoBehaviour {
		...
		private IEnumerator Start () {
			sam = gameObject.GetComponent<VRKeySetAcceMode>();
		...
		public void ShowSuccess(float seconds)
		{
			StartCoroutine(DoShowSuccess(seconds));
		}

		public IEnumerator DoShowSuccess(float seconds)
		{
